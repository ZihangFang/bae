...
class PCG(CG):
    ...
    def _operator_forward(self, A, b, x=None, M=None) -> torch.Tensor:
        """CG with owner-local vectors and operator-defined scalar products."""
        ...
        # A fixed fallback keeps every rank in the same collective sequence
        # even when uneven shards contain different local element counts.
